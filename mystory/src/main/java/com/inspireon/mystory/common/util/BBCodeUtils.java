...
public class BBCodeUtils {
	...
	public static void main(String[] args) {
		...
		System.out.println(bbCodeToHtml("[b]fdsfds[/b] [b][i]fdsfdsfds[/i][/b] [i]fdsfdsfds[/i] [i][u]fdsfdsfds[b]fdsfdsfds[/b][/u][/i] [i][u]"));
		
	}
	
	public static String bbCodeToHtml(String html){
		
		String bbCode = html;
		
		for(Map.Entry entry : getBBcodeMap().entrySet()){
