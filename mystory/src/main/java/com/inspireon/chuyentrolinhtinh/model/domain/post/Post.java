...
import com.inspireon.chuyentrolinhtinh.exception.UserAlreadyVotePostException;
import com.inspireon.chuyentrolinhtinh.exception.VoterNotFoundInPost;
...
public class Post extends Entity<Post>{
	...
	public void upVote(String newVoter) throws UserAlreadyVotePostException {
		if (isAlreadyVotedUpBy(newVoter)) {
			throw new UserAlreadyVotePostException(newVoter, this.id());
		} else {
	...
	public void downVote(String newVoter) throws UserAlreadyVotePostException {
	...
	public void unUpVote(String voter) throws VoterNotFoundInPost {
		if (isAlreadyVotedUpBy(voter)) {
			Voter unUpVoter = new Voter(voter);
			this.upVoters.remove(unUpVoter);
			this.point--;
		} else {
			throw new VoterNotFoundInPost(voter, this.id());
		}
	}
	
	public void unDownVote(String voter) throws VoterNotFoundInPost {
