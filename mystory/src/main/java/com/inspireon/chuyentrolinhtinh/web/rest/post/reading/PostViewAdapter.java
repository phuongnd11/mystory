...
public class PostViewAdapter implements Serializable {
	...
	private final List<Post> siblingChapters;
	...
	public PostViewAdapter(Post story, List<Post> siblingChapters, User author, String reader, I18NUtils i18nUtils) {
		this.story = story;
	...
	public List<ChapterViewAdapter> getPreviousChapters() {
		...
		for (Post siblingChapter : siblingChapters) {
