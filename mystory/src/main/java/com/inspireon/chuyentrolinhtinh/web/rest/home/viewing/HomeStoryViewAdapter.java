...
import com.inspireon.chuyentrolinhtinh.web.rest.story.reading.AuthorViewAdapter;

public class HomeStoryViewAdapter implements Serializable {
	
	public static Logger logger = Logger.getLogger(HomeStoryViewAdapter.class);
	...
	public HomeStoryViewAdapter(Story story, User author, String reader, I18NUtils i18nUtils) {
		this.story = story;
		this.author = author;
		this.reader = reader;
