...
<div class="content_wrapper">
	<input type="hidden" id="paged" value="${ home.page }" />
	<ul id="story_list" class="story_list">
		<c:forEach items="${ home.stories }" var="story">
			<li class="story_item <c:if test="${ story.voteCount lt -4 }">bad_story</c:if>">
				...
				<div class="author_info">
					...
					<div class="author_lower">
						<a href="<c:url value='/story/${story.id}#comment_list_wrapper'/>" title="<spring:message code='label.story.comment.count' arguments='${ story.commentCount }'/>" class="btn author_btn comment_count_btn"><span>${ story.commentCount }</span></a>
